...
function Pick() {
    ...
    const handleClick = (cardId) => {
        setCards(selected => [...selected, cardId]);
    };
    ...
    return (
        <div id='container'>
            <div id="pickArea">
                <div id="gameItems">
                    <div id="stamp-1" className="stamp blue" onClick={() => handleClick("stamp.blue")}>1</div>
                    ...
                    <div id="stamp-8" className="stamp red" onClick={() => handleClick("stamp-red")}>1</div>
